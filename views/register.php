<?php $title = "Sign Up"; require '../includes/header.php' ?>
...
<body>
  <div class="container-md">
    <form action="../server/signup.php" name="register" method="POST" class="form-group" id="register">
      <div class="d-flex flex-column align-items-center justify-content-center my-2 mx-3" style="height: 100vh;">
        ...
        <h1>Sign Up</h1>
        <input type="text" name="first_name" id="first_name" class="form-control bg-whitesmoke px-3 py-2 m-2" placeholder="First Name">
