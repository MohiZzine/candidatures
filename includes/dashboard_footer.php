<footer class="bg-dark text-white text-center p-2 position-relative">
  <div class="container-md">
    <div class="d-md-flex align-items-start justify-content-evenly my-4">
      <div class="copyright">
        <p class="lead">
          Copyright &copy; 2023 University Voting System | Mohieddine Farid
        </p>
      </div>
    ...
    <div class="updated position-absolute bottom-0 start-0 px-sm-5 d-block">
      Updated Wed 24 May 2023, 13:18:34 UTC by <a href="#" target="_blank" rel="noopener noreferrer" class="">
      </a>  
    </div>
  </div>
</footer>